...
<div align="center">
<table width="1273" height="900" border="0" cellpadding="0" cellspacing="0" background="image/1.jpg" >
  <tr>
	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
     <html:form action="/login" method="post" onsubmit="return checkloginForm(this)">
      ...
      <tr>
        <td>密&nbsp;&nbsp;码：</td>
        <td><label>
          <html:password property="password" redisplay="false" style="width:150px"/>
        </label></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td height="20" >&nbsp;&nbsp;&nbsp;<font color="blueviolet" size="6">计算机工程实践第11组</font></td>
    <td height="20">&nbsp;</td>
  </tr>
</table>
<script>
